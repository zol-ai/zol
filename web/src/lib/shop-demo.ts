...
export const beats = [
  {
    ...
    clock: "9:41 PM",
    title: "The call",
    body: "Four hours after close, ZOL picks up. Complaint, vehicle, callback — then it books the slot.",
  ...
  },
  {
    ...
    clock: "7:12 AM",
    title: "The diagnosis",
    body: "Your tech scans the car. Codes and findings attach to the record the call already opened.",
  ...
  },
  {
    ...
    clock: "8:30 AM",
    title: "The quote",
    body: "The estimate texts out with a photo and the reasoning. One nudge, then a person takes over.",
  ...
  },
  {
    ...
    clock: "4:20 PM",
    title: "The follow-up",
    body: "Ready notice, invoice, payment at your counter — and the next visit already on the book.",
...
export const jobs = [
  {
    ...
    body: "Nights and weekends. It takes the complaint, the VIN and a callback — or transcribes the voicemail and books from it.",
    event: "Booked from voicemail — transcribed 6:48p, booked 8:00a",
  },
  {
    title: "It texts back in seconds",
    body: "Inbound texts get a real answer before you open. ZOL offers slots, confirms one, writes it to the board.",
    event: "Inbound text 7:02a — answered in 8 seconds",
  },
  {
    title: "It chases approvals",
    body: "The estimate goes out with a photo and plain-English reasoning. One nudge if nobody replies, then a person takes it.",
    event: "No reply after 20h — one nudge sent, then paused",
  },
  {
    title: "It catches parts delays",
    body: "Parts get ordered against the approved estimate. When a vendor moves an ETA, the bay conflict surfaces early.",
